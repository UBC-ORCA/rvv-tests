...
void TEST_CASE1(void) {
  VSET(15, e8, m1);
  asm volatile("vle8.v v8, (%0)" ::"r"(&ALIGNED_I8[1]));
  VCMP_U8(1, v8, 0xd3, 0x40, 0xd1, 0x84, 0x48, 0x89, 0x88, 0x88, 0xae, 0x08,
          0x91, 0x02, 0x59, 0x11, 0x89);
}

void TEST_CASE2(void) {
  VSET(15, e16, m2);
  asm volatile("vle16.v v8, (%0)" ::"r"(&ALIGNED_I16[1]));
  VCMP_U16(2, v8, 0xbbd3, 0x3840, 0x8cd1, 0x9384, 0x7548, 0x3489, 0x9388,
           0x8188, 0x11ae, 0x5808, 0x4891, 0x4902, 0x8759, 0x1111, 0x1989);
}
...
void TEST_CASE3(void) {
  ...
  VCMP_U32(3, v8, 0xf9aa71f0, 0xa11a9384, 0x99991348, 0x9fa831c7, 0x38197598,
