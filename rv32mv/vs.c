...
void TEST_CASE1(void) {
  VSET(15, e8, m1);
  VLOAD_8(v8, 0xe4, 0x19, 0x20, 0x9f, 0xe4, 0x19, 0x20, 0x9f, 0xe4, 0x19, 0x20,
          0x9f, 0xe4, 0x19, 0x20);
  asm volatile("vse8.v v8, (%0)" ::"r"(&ALIGNED_O8[1]));
...
void TEST_CASE2(void) {
  VSET(15, e16, m2);
  VLOAD_16(v8, 0xe478, 0x1549, 0x3240, 0x2f11, 0xe448, 0x1546, 0x3220, 0x9f11,
           0xe478, 0x1549, 0x3240, 0x2f11, 0xe448, 0x1546, 0x3220);
  asm volatile("vse16.v v8, (%0)" ::"r"(&ALIGNED_O16[1]));
